...
//					alert(data.client_name.f_name);
					$('#fname').val(data.client_name.f_name);
					$('#lname').val(data.client_name.l_name);
...
//			alert("working");
			...
			//alert(email1);
			// Returns successful data submission message when the entered information is stored in database.
			if(email1=='' && dd1=='' && mm1=='' && pass_employer=='' && yyyy1=='' && zip1 == '' &&  !(fname2=='' || lname2=='' || email2=='' || city2=='' || dd2=='' || mm2=='' || yyyy2=='' || pno2=='' || zip2 == '' || add2 == '' || comp2 == '')){
